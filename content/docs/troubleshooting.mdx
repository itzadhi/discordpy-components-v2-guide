---
title: "FAQ and Troubleshooting: Unknown Interaction, Missing Intents, Bad Permissions, Sync Issues, Event Loop Blocking, and Hosting Problems"
...
<MermaidDiagram
  title="FAQ and Troubleshooting: Unknown Interaction, Missing Intents, Bad Permissions, Sync Issues, Event Loop Blocking, and Hosting Problems flow"
  chart={
    'flowchart LR\n    A["Symptom"] --> B["Cause"]\n    B --> C["Fix"]\n    C --> D["Modern response"]\n    D --> E["Logs, metrics, and next action"]'
  }
/>

<ReferenceTable data='{"headers":["Layer","What happens","Production question"],"rows":[["Discord layer","Receives Symptom and sends an async interaction or gateway event.","Which intent, permission, or response deadline applies?"],["Python layer","The event loop dispatches Cause without blocking other callbacks.","Are you awaiting I/O instead of blocking the loop?"],["Service layer","Runs Fix with persistence, logging, and clear errors.","What survives restart and what must be re-registered?"]]}' />
...
<ComparisonTabs data='[{"label":"Beginner","value":"beginner","body":"Focus on the user story: what the person clicks, selects, submits, or expects from FAQ and Troubleshooting: Unknown Interaction, Missing Intents, Bad Permissions, Sync Issues, Event Loop Blocking, and Hosting Problems."},{"label":"Intermediate","value":"intermediate","body":"Move repeated behavior into typed handlers, services, validation helpers, and small modules."},{"label":"Production","value":"production","body":"Add persistence, permission guards, observability, rate-limit awareness, and deployment-safe boundaries."}]' />
